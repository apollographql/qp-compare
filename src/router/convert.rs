...
impl From<&'_ next::FetchNode> for plan::SubscriptionNode {
...
impl From<&'_ Arc<next::FetchDataRewrite>> for plan::DataRewrite {
...
impl From<&'_ next::FetchDataValueSetter> for plan::DataValueSetter {
...
impl From<&'_ next::FetchDataKeyRenamer> for plan::DataKeyRenamer {
...
impl From<&'_ next::FetchDataPathElement> for path::PathElement {
